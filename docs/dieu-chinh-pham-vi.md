...
| 27/08/2026 | Quy trình 6 nhịp: không tác tử nào chạy lệnh; mọi phép kiểm gói vào kịch bản `docs/kiem-may/*.ps1` cho sinh viên chạy | **Quy trình 5 nhịp: `coder` tự chạy phần tự kiểm của nó** (`black`, `ruff`, `pytest` host và container, phép đột biến) trong phiên VS Code riêng; **khâu kiểm định vẫn do sinh viên chạy**, nhưng bằng **lệnh rời** thay vì kịch bản gộp. Thư mục `docs/kiem-may/` đóng băng, giữ lại làm di tích của `P3-01b` | Kịch bản gộp chỉ chạy được **hai ngày** (25–27/08) và bộc lộ ba nhược điểm: mỗi lần sửa một dòng mã lại tốn một nhịp chờ người chạy; bản thân kịch bản trở thành phần mềm thứ hai phải bảo trì (đã treo ở `less` vì thiếu `$env:GIT_PAGER`); đầu ra gộp làm lỗi thật lẫn giữa hàng trăm dòng xanh. Ranh giới đặt lại theo **ai chấm ai** chứ không theo cách đóng gói: người viết mã tự kiểm được, nhưng **không được tự chấm** — số vào biên bản review vẫn đến từ lượt chạy của người thật, giữ nguyên R5/R6 | `CLAUDE.md` §2.9 R42, `docs/kiem-may/README.md` |
